...
public record DailyRoutineResponse(
    ...
    int? GameTimerSessionMinutes,
    DateTime? GameTimerSessionStartedAt,
    DateTime? GameTimerSessionEndsAt,
    int? GameTimerSessionRemainingSeconds,
    ...
    DateTime? TomorrowPlanConfirmedAt
);
...
public static class DailyRoutineMappingExtensions
{
    ...
    public static DailyRoutineResponse ToResponse(this DailyRoutine routine) => new(
        ...
        routine.GameTimerSessionMinutes,
        routine.GameTimerSessionStartedAt,
        routine.GameTimerSessionEndsAt,
        routine.GameTimerSessionRemainingSeconds,
        ...
        routine.TomorrowPlanConfirmedAt);
