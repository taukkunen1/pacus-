...
public interface IDailyRoutineRepository
{
    ...
    // Concorrencia otimista via DailyRoutine.Version (achado #5 da auditoria de API de
    // 2026-09-01 -- ver docs/ESTADO_ATUAL.md): lanca ConflictException se a rotina foi
    // alterada por outra requisicao entre a leitura e esta gravacao.
