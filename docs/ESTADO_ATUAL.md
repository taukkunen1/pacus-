...
- **Backend antigo no Render (`pacus.onrender.com`):** segue no ar por enquanto, sem tráfego de produção real (nenhum frontend aponta mais pra ele); decisão sobre desligá-lo de vez ainda pendente, a critério do dono do produto.
