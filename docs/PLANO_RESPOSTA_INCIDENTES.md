...
**Monitoramento automatizado de disponibilidade:** o workflow `.github/workflows/production-health.yml` verifica a cada 15 minutos frontend, API, conexão com MongoDB e política CORS. Ainda não há IDS/detecção comportamental de acesso anômalo; essa camada deve ser revisitada se a base de usuários crescer.
